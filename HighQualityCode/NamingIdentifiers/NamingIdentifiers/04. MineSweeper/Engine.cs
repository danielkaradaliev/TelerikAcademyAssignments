namespace Minesweeper
{
    ...
    internal static class Engine
    {
        ...
        internal static readonly string AskPlayerForCoordinates = "Please enter row and column: ";
            ...
            do
            {
                ...
                if (steppedOnMine)
                {
                    ...
                    else
                    {
                        ...
                        {
                            if (champions[i].Points < looser.Points)
                            {
                    ...
                    champions.Sort((Player a, Player b) => b.Name.CompareTo(a.Name));
                    champions.Sort((Player a, Player b) => b.Points.CompareTo(a.Points));
                    PrintRanking(champions);
