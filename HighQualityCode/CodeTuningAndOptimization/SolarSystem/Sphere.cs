namespace Surfaces
{
    ...
    public sealed class Sphere : Surface
    {
        ...
        private const double AngleD = (MaxAngle - MinAngle) / AngleSteps;
        private const int StepsY = 32;
        private const double MinY = -1.0;
        private const double MaxY = 1.0;
        private const double Dy = (MaxY - MinY) / StepsY;
