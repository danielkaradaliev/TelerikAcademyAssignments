namespace Surfaces
{
    ...
    public sealed class Circle : Surface
    {
        ...
        {
            var pointForAngle = new Point3D(this.position.X + (this.radius * Math.Cos(angle)), this.position.Y + (this.radius * Math.Sin(angle)), this.position.Z);
