namespace SchoolClasses
{
    ...
    public class Class : ICommentable
    {
        ...
        public Class(char identifier, string comment)
            : this(identifier)
        {
        ...
        public override string ToString()
        {
            ...
            {
                result.AppendLine(string.Format("* {0}, teaches ", this.teachers[i].Name));
            ...
            for (int i = 0; i < this.students.Count; i++)
            {
                ...
                {
                    result.AppendLine(string.Format("{0} is {1}.", this.students[i].Name, this.students[i].Comment));
                }
            }
